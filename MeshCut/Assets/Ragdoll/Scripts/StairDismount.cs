...
public class StairDismount : MonoBehaviour {
	...
	void Update () {
		...
		if (Input.GetMouseButtonDown(0))
		{
			...
			//			testRot.position = Camera.main.transform.position;
			//			testRot.LookAt(ray.origin);

			testRot.position = ray.origin;
			testRot.LookAt(testRot.position + ray.direction);
